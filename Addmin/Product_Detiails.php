                ...
                <?php
                    ...
                    if($result) {
                        ...
                        <tr>
                            ...
                            <td><a class="btn-outline-success" href="Product_Update.php ? id=<?php echo $row['id']; ?>">Edit</a></td>
                            <td><a class="btn-outline-danger" onclick="return confirm('Are you sure , you want to delete.?)" href="Product_Delite.php ? id=<?php echo $row['id']; ?>">Delete</a></td>
