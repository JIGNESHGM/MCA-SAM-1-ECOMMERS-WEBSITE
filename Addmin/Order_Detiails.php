                ...
                <?php
                    ...
                    if($result) {
                        ...
                        <tr>
                            ...
                            <td align="center"><a class="btn-outline-danger" onclick="return confirm('Are you sure , you want to delete.?)" href="Order_Delite.php?id=<?php echo $row['id']; ?>">Delete</a></td>
