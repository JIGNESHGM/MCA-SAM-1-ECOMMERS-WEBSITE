<?php
    ...
    $old_password= md5(md5(mysqli_real_escape_string($con,isset($_POST['oldPassword']) ? $_POST['oldPassword'] : "")));
    $new_password= md5(md5(mysqli_real_escape_string($con,isset($_POST['newPassword']) ? $_POST['newPassword'] : "")));
